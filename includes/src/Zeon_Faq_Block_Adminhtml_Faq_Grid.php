...
class Zeon_Faq_Block_Adminhtml_Faq_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->distinct()
            ->join(array('zfc'=> Mage::getResourceModel('zeon_faq/category')->getTable('zeon_faq/category')), 'main_table.category_id = zfc.category_id',array('category_name'=>'title'));
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('faq_category', array(
            'header' => Mage::helper('zeon_faq')->__('FAQ Category'),
            'type'   => 'text',
            'index'  => 'category_name',
        ));

        $this->addColumn('is_most_frequently', array(
