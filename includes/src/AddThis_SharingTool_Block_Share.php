...
class AddThis_SharingTool_Block_Share extends Mage_Core_Block_Template
{
    ...
    public function getCustomServiceName(){
    	...
    	return Mage::getStoreConfig('sharing_tool/api/services_custom_name');
    }
    
    public function getCustomServiceUrl(){
    
    	return Mage::getStoreConfig('sharing_tool/api/services_custom_url');
    }
    
    public function getCustomServiceIcon(){
    
    	return Mage::getStoreConfig('sharing_tool/api/services_custom_icon');
    }
    ...
    public function getUiHeaderColor(){
    	...
    	return Mage::getStoreConfig('sharing_tool/api/ui_header_color');
    }
        
    public function getUiHeaderBgColor(){
    
    	return Mage::getStoreConfig('sharing_tool/api/ui_header_background');
    }
