...
class NovaWorks_RevSlideshow_Helper_Image extends Mage_Core_Helper_Abstract
{
	/**
	 ...
	 * @var const string
	 */
	const IMAGE_FOLDER = 'revslideshow';
	 ...
	 *
	 * @param NovaWorks_AttributeSplash_Model_Page $page
	 * @param string $attribute
	 * @return NovaWorks_AttributeSplash_Helper_Image
	 */
	public function init(NovaWorks_AttributeSplash_Model_Page $page, $attribute = 'image')
	{
