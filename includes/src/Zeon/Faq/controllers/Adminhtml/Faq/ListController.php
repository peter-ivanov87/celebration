...
class Zeon_Faq_Adminhtml_Faq_ListController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        $this->_title($this->__('Zeon Extensions'))->_title($this->__('Faq'));
        $this->loadLayout();
    ...
    public function editAction()
    {
        ...
        if (!$model->getId() && $id) {
            Mage::getSingleton('adminhtml/session')->addError(Mage::helper('zeon_faq')->__('This faq no longer exists.'));
            $this->_redirect('*/*/');
            return;
        }
    ...
    public function saveAction()
    {
        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('zeon_faq')->__('The faq has been saved.'));
    ...
    public function deleteAction()
    {
        ...
        if ($id = $this->getRequest()->getParam('id')) {
            ...
            Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('zeon_faq')->__('The faq has been deleted.'));
            // go to grid
            $this->_redirect('*/*/');
            return;
            } catch (Mage_Core_Exception $e) {
                ...
                $this->_getSession()->addError(Mage::helper('zeon_faq')->__('An error occurred while deleting faq data. Please review log and try again.'));
                Mage::logException($e);
        ...
        Mage::getSingleton('adminhtml/session')->addError(Mage::helper('zeon_faq')->__('Unable to find a faq to delete.'));
        // go to grid
        $this->_redirect('*/*/');
    }
    ...
    public function massDeleteAction()
    {
        ...
        if (!is_array($ids)) {
            ...
            try {
                ...
                $this->_getSession()->addError(Mage::helper('zeon_faq')->__('An error occurred while mass deleting faq. Please review log and try again.'));
                Mage::logException($e);
                return;
            }
        }
    ...
    public function massStatusAction()
    {
        ...
        if (!is_array($ids)) {
            ...
            try {
                ...
                $this->_getSession()->addError(Mage::helper('zeon_faq')->__('An error occurred while mass updating faq. Please review log and try again.'));
                Mage::logException($e);
                return;
            }
        }
